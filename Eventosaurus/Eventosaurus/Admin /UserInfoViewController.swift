...
class UserInfoViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    var statusOption: [String] = ["Organizer", "Attendee"] //status options. onload, depending on the type of user, this will load. 
    ...
    override func viewDidLoad() {
        ...
        // Initially disable the Save button, only enable once there are chnages made to the text fields
    ...
    @IBAction func saveButtonTapped(_ sender: UIButton) {
        ...
        // Update Firestore with the new data, referneces the method defined below
